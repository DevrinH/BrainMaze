...
function startReadingWritingModule2() {
    time = 32 * 60;
    refreshIntervalId = setInterval(updateCountdown, 1000);
...
function showScore() {
    resetState();
    let maxPossibleScore = 6; // Adjusted for sample size (2 easy, 2 med, 2 hard max)
    let rawScore = score;
...
function showIntroMessage() {
    resetState();
    passageElement.innerHTML = "";
    questionElement.innerHTML = "This is a timed Digital SAT Test: 64 min for Reading/Writing, 70 min for Math.";
    questionElement.classList.add("centered-score");
