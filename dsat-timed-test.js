...
function generateExplanation(response) {
    const questionText = response.question || ""; // Default to empty string if undefined
    const passageText = response.passage || "";   // Extract passage if separate, else use question
    ...
    // Extremely Hard Explanations (Algebra)
        ...
        // Extremely Hard Explanations (Advanced Math)
            ...
            // Mildly Hard Explanations (Problem Solving and Data Analysis)
        ...
        // Mildly Hard Explanations (Geometry and Trigonometry)
