...
const readingWritingQuestions = [
    {
        ...
        answers: [
            ...
            { text: "B) She feels out of place despite having anticipated this moment.", correct: true },
    ...
    {
        passage: "Daniel stepped into the office, straightening his tie as he took in the bustling atmosphere...",
        question: "What does the passage suggest about Daniel's attitude toward his new job?",
        answers: [
            { text: "A) He is uninterested and only took the job for financial reasons.", correct: false },
            { text: "B) He is confident he will excel without challenges.", correct: false },
            { text: "C) He regrets accepting the position and considers quitting.", correct: false },
            { text: "D) He is uncertain about his abilities but determined to prove himself.", correct: true }
        ],
        type: "reading",
        difficulty: "medium",
        category: "inference"
    ...
    {
        passage: "Liam set his pen down and exhaled slowly...",
        question: "Which choice provides the best evidence for Liam’s uncertainty about his work?",
        answers: [
            { text: "A) 'He reread the paragraph, then again, each time questioning whether his words carried the weight he had intended.'", correct: false },
            { text: "B) 'Liam set his pen down and exhaled slowly...'", correct: false },
            { text: "C) 'Months of tireless effort had led to this moment, yet a nagging doubt lingered in his mind.'", correct: true },
            { text: "D) 'He had imagined this moment countless times...'", correct: false }
        ],
        type: "reading",
        difficulty: "hard",
    ...
    },
    {
        ...
        answers: [
            { text: "A) 'The results were unexpected...'", correct: false },
            { text: "B) 'She tapped her fingers against the desk...'", correct: false },
            { text: "C) 'The scientist adjusted her glasses...'", correct: false },
            { text: "D) 'There had to be a mistake...'", correct: true }
        ],
        type: "reading",
        difficulty: "medium",
        category: "command-of-evidence"
    ...
    {
        passage: "Dr. Patel reviewed the data from her latest experiment...",
        question: "Which detail in the passage best supports the idea that Dr. Patel is persistent?",
        answers: [
            { text: "A) She sighed while reviewing the data.", correct: false },
            { text: "B) Her brow furrowing as the results contradicted her hypothesis.", correct: false },
            { text: "C) She had spent months refining her methods.", correct: true },
            { text: "D) The numbers refused to align.", correct: false }
        ],
        type: "reading",
        difficulty: "easy",
        category: "command-of-evidence"
    ...
    {
        passage: "The explorer trudged through the dense jungle...",
        ...
        answers: [
            ...
            { text: "B) He consulted his worn map.", correct: false },
            { text: "C) His boots sank into the mud.", correct: false },
            { text: "D) He pressed on, driven by tales of a hidden temple.", correct: true }
        ],
        type: "reading",
        difficulty: "easy",
        category: "command-of-evidence"
    ...
    {
        passage: "Clara stood at the edge of the stage...",
        question: "Which detail best demonstrates Clara overcoming her initial nervousness?",
        answers: [
            { text: "A) The audience waited in silence.", correct: false },
            { text: "B) Her voice shaky but growing steadier.", correct: true },
            { text: "C) She had rehearsed for weeks.", correct: false },
            { text: "D) Her script trembling in her hands.", correct: false }
        ],
        type: "reading",
        difficulty: "easy",
        category: "command-of-evidence"
    ...
    {
        passage: "The baker kneaded the dough with practiced hands...",
        question: "What evidence best supports the baker’s commitment to his work?",
        answers: [
            { text: "A) Orders had piled up since dawn.", correct: false },
            { text: "B) The oven hummed relentlessly.", correct: false },
            { text: "C) He paused only to wipe his brow, then returned to his task.", correct: true },
            { text: "D) Flour dusting the air around him.", correct: false }
        ],
        type: "reading",
        difficulty: "easy",
        category: "command-of-evidence"
    ...
    {
        passage: "The economist pored over the charts...",
        ...
        answers: [
            ...
            { text: "B) Critics argued the data was skewed...", correct: false },
            { text: "C) Her findings gained traction among policymakers.", correct: false },
            { text: "D) She countered with evidence of a consistent pattern across multiple years.", correct: true }
        ],
        type: "reading",
        difficulty: "medium",
        category: "command-of-evidence"
    ...
    {
        passage: "The climber gripped the icy ledge...",
        question: "What evidence most clearly shows the climber’s resilience?",
        answers: [
            { text: "A) The storm’s sudden arrival tested her resolve.", correct: false },
            { text: "B) Her breath visible in the frigid air.", correct: false },
            { text: "C) Ignoring the wind’s howl, she pushed upward.", correct: true },
            { text: "D) She had trained for this ascent.", correct: false }
        ],
        type: "reading",
        difficulty: "medium",
        category: "command-of-evidence"
    ...
    {
        passage: "The historian sifted through dusty archives...",
        question: "Which detail best strengthens the historian’s argument?",
        answers: [
            { text: "A) Many dismissed her theory as speculation.", correct: false },
            { text: "B) Sifted through dusty archives.", correct: false },
            { text: "C) Her peers remained skeptical, yet intrigued.", correct: false },
            { text: "D) She pointed to an overlooked correspondence that corroborated her claims.", correct: true }
        ],
        type: "reading",
        difficulty: "medium",
        category: "command-of-evidence"
    ...
    {
        passage: "The engineer stared at the blueprint...",
        ...
        answers: [
            ...
            { text: "B) The project deadline loomed.", correct: false },
            { text: "C) Colleagues urged a complete overhaul.", correct: false },
            { text: "D) Citing stress test results that showed stability.", correct: true }
        ],
        type: "reading",
        difficulty: "medium",
        category: "command-of-evidence"
    ...
    {
        passage: "The biologist examined the samples...",
        ...
        answers: [
            ...
            { text: "B) She proposed an untested variable—temperature fluctuations.", correct: false },
            { text: "C) She noted the sterile conditions maintained throughout.", correct: true },
    ...
    {
        passage: "The diplomat navigated the tense negotiations...",
        question: "What evidence most effectively counters the critics’ accusation of stalling?",
        answers: [
            { text: "A) Critics accused her of stalling.", correct: false },
            { text: "B) Her words measured as she addressed the assembly.", correct: false },
            { text: "C) The room fell silent, reevaluating her strategy.", correct: false },
            { text: "D) She referenced a prior agreement’s overlooked clause.", correct: true }
        ],
        type: "reading",
        difficulty: "hard",
        category: "command-of-evidence"
    ...
    {
        passage: "The poet scribbled furiously...",
    ...
    {
        passage: "The physicist reviewed the equations...",
        question: "What evidence most strongly refutes the peers’ suggestion of rounding errors?",
        answers: [
            { text: "A) She theorized an undetected particle.", correct: false },
            { text: "B) Troubled by a discrepancy in the energy outputs.", correct: false },
            { text: "C) Pointing to a calibration log that confirmed precision.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A) Sailors depend on lighthouses to navigate dangerous waters.", correct: false },
            { text: "B) The lighthouse represents resilience in the face of adversity.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A) Children enjoy the harvest festival more than adults.", correct: false },
            { text: "B) The village relies heavily on successful crop yields.", correct: false },
            { text: "C) The festival highlights the importance of community unity.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A) A cluttered workspace fosters creativity.", correct: false },
            { text: "B) Success requires avoiding repeated mistakes.", correct: false },
            { text: "C) The inventor views failure as a necessary part of progress.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A) Floods and droughts challenge the valley’s residents.", correct: false },
            { text: "B) Wildlife depends more on the river than humans do.", correct: false },
            { text: "C) The river’s beauty defines the valley’s identity.", correct: false },
            { text: "D) The river is essential to the valley’s way of life.", correct: true }
        ],
        type: "reading",
        difficulty: "easy",
        category: "central ideas"
    },
    {
        ...
        question: "What is the central idea of the passage?",
        answers: [
            { text: "A) Critics fail to appreciate the depth of the playwright’s characters.", correct: false },
            { text: "B) The playwright seeks to reshape how history is remembered.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A) The desert is more dangerous than it appears to outsiders.", correct: false },
            { text: "B) The nomads’ survival depends on understanding their environment.", correct: true },
    ...
    },
    {
        ...
        question: "What is the central theme of the passage?",
        answers: [
            { text: "A) Old books are more valuable than modern ones.", correct: false },
            { text: "B) The librarian values the enduring influence of literature.", correct: true },
    ...
    },
    {
        ...
        question: "What is the central idea of the passage?",
        answers: [
            { text: "A) Optical illusions prove that reality is an illusion.", correct: false },
            { text: "B) The philosopher believes truth is subjective and dependent on perception.", correct: true },
    ...
    },
    {
        ...
        question: "What is the main idea of the passage?",
        answers: [
            { text: "A) Viewers misinterpret the artist’s focus on decay.", correct: false },
            { text: "B) The artist portrays the interconnection of beauty and impermanence.", correct: true },
    ...
    },
    {
        ...
        question: "What is the central theme of the passage?",
        answers: [
            { text: "A) Speculative bubbles inevitably lead to economic collapse.", correct: false },
            { text: "B) The economist sees markets as fragile systems requiring balance.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A) She finds them outdated and irrelevant.", correct: false },
            { text: "B) She values them despite their lack of popularity.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A) She is nervous and likely to underperform again.", correct: false },
            { text: "B) She believes the cold weather will slow her down.", correct: false },
            { text: "C) She is more thorough in her preparation after her recent loss.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A) She is unsure but follows their suggestions reluctantly.", correct: false },
            { text: "B) She feels pressured to change her style completely.", correct: false },
            { text: "C) She deliberately rejects it in favor of her own vision.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A) She is confident the anomalies will resolve themselves.", correct: false },
            { text: "B) She regrets sharing her earlier findings.", correct: false },
            { text: "C) She is unsettled and determined to understand the discrepancies.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A) He enjoys bargaining more than making sales.", correct: false },
            { text: "B) He prioritizes profit margins over high sales volume.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A) She thinks he is disengaged and needs motivation.", correct: false },
            { text: "B) She believes he has potential that he doesn’t fully express.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A) She hides her frustration to maintain appearances.", correct: false },
            { text: "B) She uses an unexpected tactic to regain control amid strained relations.", correct: true },
            { text: "C) She is desperate to appease her counterparts.", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "A) She struggles with self-doubt despite external praise.", correct: false },
            { text: "B) She embraces imperfection as a core part of her artistry.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A) She fears the prototype will fail under scrutiny.", correct: false },
            { text: "B) She values precision over meeting external deadlines.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A) Measure", correct: false },
            { text: "B) Observe", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A) Reduce", correct: false },
            { text: "B) Rewrite", correct: false },
            { text: "C) Perfect", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A) Repair", correct: false },
            { text: "B) Replace", correct: false },
            { text: "C) Redesign", correct: false },
            { text: "D) Reestablish", correct: true }
        ],
        type: "reading",
        difficulty: "easy",
        category: "words in context"
...
// Words in Context MEDIUM
{
    ...
    answers: [
        { text: "A) Brightened", correct: false },
        { text: "B) Explained", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Understand", correct: false },
        { text: "B) Enter", correct: false },
        { text: "C) Break through", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Analysis", correct: false },
        { text: "B) Simplification", correct: false },
        { text: "C) Separation", correct: false },
        { text: "D) Combination", correct: true },
    ],
    type: "reading",
    difficulty: "medium",
    category: "words in context"
},
{
    ...
    answers: [
        { text: "A) Destroying", correct: false },
        { text: "B) Resisting", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Overturn", correct: false },
        { text: "B) Weaken", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Hidden", correct: false },
        { text: "B) Imitated", correct: false },
        { text: "C) Infused", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Confused", correct: false },
        { text: "B) Entrapped", correct: false },
        { text: "C) Enriched", correct: false },
        { text: "D) Deeply established", correct: true },
    ],
    type: "reading",
    difficulty: "hard",
    category: "words in context"
...
// Text Structure EASY
{
    ...
    answers: [
        { text: "A) To argue for the replacement of an outdated bridge", correct: false },
        { text: "B) To describe the condition of an aging bridge and its current evaluation", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) By comparing the festival to other town events", correct: false },
        { text: "B) Through a problem-solution framework about noise", correct: false },
        { text: "C) Chronologically, detailing the progression of a festival", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) To detail the variety of species in rainforests", correct: false },
        { text: "B) To outline the impact of deforestation on rainforests and advocate for conservation", correct: true },
...
},
{
    ...
    question: "How is the passage primarily structured?",
    answers: [
        { text: "A) By comparing different baking techniques", correct: false },
        { text: "B) Through a cause-and-effect analysis of ingredients", correct: false },
        { text: "C) Descriptively, focusing on the loaf’s qualities", correct: false },
        { text: "D) Sequentially, providing steps to bake bread", correct: true },
    ],
    type: "reading",
    difficulty: "easy",
    category: "text-structure-and-purpose"
...
},
{
    ...
    question: "What is the primary purpose of the passage?",
    answers: [
        { text: "A) To argue against the expansion of cities", correct: false },
        { text: "B) To examine the effects of urban sprawl and present a potential solution", correct: true },
...
},
{
    ...
    question: "How is the passage primarily structured?",
    answers: [
        { text: "A) By comparing different characters’ perspectives", correct: false },
        { text: "B) Through a cause-and-effect analysis of the murder", correct: false },
        { text: "C) Sequentially, following the unfolding of a mystery", correct: true },
...
},
{
    ...
    question: "What is the main purpose of the passage?",
    answers: [
        { text: "A) To explain the science behind rising sea levels", correct: false },
        { text: "B) To criticize the slow adoption of renewable energy", correct: false },
        { text: "C) To highlight climate change’s consequences and urge action", correct: true },
...
// Text Structure HARD
{
    ...
    question: "How is the passage primarily structured?",
    answers: [
        { text: "A) Chronologically, tracing the history of liberty", correct: false },
        { text: "B) Thematically, exploring freedom across time with philosophical support", correct: true },
...
},
{
    ...
    question: "What is the primary purpose of the passage?",
    answers: [
        { text: "A) To critique critics’ focus on poetic form", correct: false },
        { text: "B) To convey the poet’s goal of reflecting life’s complexity through shifting tones", correct: true },
...
},
{
    ...
    question: "How is the passage primarily structured?",
    answers: [
        { text: "A) Sequentially, detailing species decline over time", correct: false },
        { text: "B) By blending data and narrative to engage and persuade", correct: true },
...
},
{
    ...
    question: "What is the main purpose of the passage?",
    answers: [
        { text: "A) To compare ancient and modern conflicts", correct: false },
        { text: "B) To challenge linear views of history with interconnected examples", correct: true },
...
// Cross Text Connections EASY 
{
    ...
    answers: [
        { text: "A) Passage 1 focuses on books, while Passage 2 emphasizes workshops.", correct: false },
        { text: "B) Passage 1 depicts a quiet, underused space, while Passage 2 shows a lively, popular one.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Passage 1 values tradition, while Passage 2 focuses on innovation.", correct: false },
        { text: "B) Passage 1 shows a solitary, simple process, while Passage 2 depicts a collaborative, complex one.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Passage 1 focuses on dancing, while Passage 2 describes listening.", correct: false },
        { text: "B) Passage 1 portrays a small event, while Passage 2 depicts a large one.", correct: false },
        { text: "C) Passage 1 emphasizes tradition, while Passage 2 highlights innovation.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Passage 1 uses data, while Passage 2 relies on opinions.", correct: false },
        { text: "B) Passage 1 sees it as economically beneficial, while Passage 2 views it as environmentally harmful.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Passage 1 values rhyme, while Passage 2 prefers prose.", correct: false },
        { text: "B) Passage 1 embraces structure as liberating, while Passage 2 sees it as restrictive.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Passage 1 emphasizes tests, while Passage 2 discusses questions.", correct: false },
        { text: "B) Passage 1 focuses on rote learning, while Passage 2 prioritizes critical thinking.", correct: true },
...
// Cross Text HARD
{
    ...
    answers: [
        { text: "A) Passage 1 focuses on events, while Passage 2 examines eras.", correct: false },
        { text: "B) Passage 1 views it as a progressive sequence, while Passage 2 sees it as a recurring cycle.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Passage 1 focuses on competition, while Passage 2 discusses wealth.", correct: false },
        { text: "B) Passage 1 sees markets as naturally effective, while Passage 2 views them as flawed and needing control.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Passage 1 focuses on species, while Passage 2 examines ecosystems.", correct: false },
        { text: "B) Passage 1 emphasizes slow, steady adaptation, while Passage 2 highlights rapid change from disturbance.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Passage 1 focuses on form, while Passage 2 discusses content.", correct: false },
        { text: "B) Passage 1 views it as an expression of beauty, while Passage 2 sees it as a reflection of societal dynamics.", correct: true },
...
// Transitions EASY
{
    ...
    answers: [
        ...
        { text: "B) As a result", correct: true },
...
},
{
    ...
    answers: [
        ...
        { text: "C) Consequently", correct: true },
...
},
{
    ...
    question: "Which transition best fits the blank?",
    answers: [
        { text: "A) Because", correct: false },
        { text: "B) Thus", correct: false },
        { text: "C) Moreover", correct: false },
        { text: "D) Alternatively", correct: true },
    ],
    type: "reading",
    difficulty: "easy",
    category: "transitions"
...
},
{
    ...
    answers: [
        ...
        { text: "B) Unfortunately", correct: true },
...
},
{
    ...
    answers: [
        ...
        { text: "C) By contrast", correct: true },
        { text: "D) Meanwhile", correct: false },
    ],
    type: "reading",
    difficulty: "medium",
...
},
{
    ...
    answers: [
        ...
        { text: "B) Thus", correct: false },
        { text: "C) Furthermore", correct: true },
...
// Transitions HARD
{
    ...
    answers: [
        { text: "A) For example", correct: false },
        { text: "B) In practice", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) In addition", correct: false },
        { text: "B) Conversely", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Because", correct: false },
        { text: "B) Thus", correct: false },
        { text: "C) On the other hand", correct: true },
...
// Rhetorical Synthesis EASY
{
    ...
    answers: [
        { text: "A) Costing $500,000, the park has sparked some debate over its funding.", correct: false },
        { text: "B) The new park will offer playgrounds, trails, and picnic areas to enhance recreation and draw visitors.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Student participation in recycling remains inconsistent despite efforts.", correct: false },
        { text: "B) The school is tackling waste with bins and lessons in a new program.", correct: false },
        { text: "C) The recycling program has cut school trash by 20% through bins and lessons.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) The bakery is hiring five workers for its expansion next month.", correct: false },
        { text: "B) Due to growing demand, our bakery will open a new spot next month with cakes, bread, and coffee.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) The garden plans to start composting next season with volunteer help.", correct: false },
        { text: "B) Last year, 200 lbs of produce came from the efforts of 30 gardeners.", correct: false },
        { text: "C) With 30 volunteers, the garden grew 200 lbs of food last year, strengthening community ties.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Despite high costs and weather issues, the city projects $100,000 in savings.", correct: false },
        { text: "B) Solar panels on 50 buildings aim to reduce emissions and save $100,000 yearly.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Some found the exhibit preachy, though 5,000 visited in a month.", correct: false },
        { text: "B) Featuring sculptures and more, the exhibit explores climate change themes.", correct: false },
        { text: "C) The climate change exhibit, with paintings and interactive pieces, drew 5,000 engaged visitors in its first month.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Funded by grants and donations, we need more volunteers to help refugees.", correct: false },
        { text: "B) Last year, we provided housing, job training, and language classes to 200 refugee families with your support.", correct: true },
...
// Rhetorical Synthesis HARD
{
    ...
    answers: [
        { text: "A) Green roofs reduce power by 15%, though high costs limit their use.", correct: false },
        { text: "B) As climate change intensifies heat waves, our study shows green roofs lower urban temperatures by 5°C and cut energy use by 15%.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Though AI ethics raise concerns, our cars succeeded in 90% of trials.", correct: false },
        { text: "B) Our self-driving cars, with sensors and AI, achieved a 90% success rate over 10,000 miles, promising safer and more efficient roads.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Despite business pushback, the tax may reduce emissions by 10%.", correct: false },
        { text: "B) Environmentalists back the tax for its revenue, projected to aid tech.", correct: false },
        { text: "C) The carbon tax could cut emissions by 10% while generating funds for green technology, tackling climate change on two fronts.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Though criticized for broad focus, we hosted 15 diverse artists.", correct: false },
        { text: "B) Bringing 15 artists from 5 countries together, our residency produced 30 exhibited works, enriching global creativity and exchange.", correct: true },
...
// Boundaries EASY
{
    ...
    answers: [
        { text: "A) Next year, the town plans to build a new park near the fairgrounds.", correct: false },
        { text: "B) The fair remains a cherished tradition, offering fun for all ages.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) The library also offers adult book clubs on weekends.", correct: false },
        { text: "B) These sessions create a love of reading that lasts a lifetime.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) The owner plans to open a second shop next year.", correct: false },
        { text: "B) Artisan bread is healthier than mass-produced options.", correct: false },
        { text: "C) This dedication keeps the bakery a local favorite.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Nearby trails are more challenging for experienced hikers.", correct: false },
        { text: "B) The forest is home to rare bird species.", correct: false },
        { text: "C) Hikers should bring water and snacks for safety.", correct: false },
        { text: "D) The trail provides an accessible escape into nature.", correct: true },
    ],
    type: "reading",
    difficulty: "easy",
    category: "boundaries"
...
},
{
    ...
    answers: [
        { text: "A) She hopes to exhibit smaller paintings in a gallery.", correct: false },
        { text: "B) Her work keeps the past alive in the public’s eye.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Competitors offer more advanced features at a higher cost.", correct: false },
        { text: "B) This ease of use makes fitness tracking approachable for all.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Folk music has deep historical roots in the region.", correct: false },
        { text: "B) Famous bands often draw larger crowds elsewhere.", correct: false },
        { text: "C) This choice keeps the event rooted in community spirit.", correct: true },
...
// Boundaries HARD
{
    ...
    answers: [
        { text: "A) Urban heat waves are worsening due to climate change.", correct: false },
        { text: "B) These results underscore gardens’ role in sustainable cities.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) The author drew from personal tragedy to write it.", correct: false },
        { text: "B) This structure amplifies the rawness of her loss.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) Cleaner tech is expensive but widely available.", correct: false },
        { text: "B) Factories have long resisted environmental regulations.", correct: false },
        { text: "C) This early progress hints at the policy’s potential.", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) The speaker plans more talks on folklore next year.", correct: false },
        { text: "B) Myths vary widely between Eastern and Western cultures.", correct: false },
        { text: "C) Attendees enjoyed the lecture’s engaging delivery.", correct: false },
        { text: "D) Such stories reveal the enduring threads of human belief.", correct: true },
    ],
    type: "reading",
    difficulty: "hard",
    category: "boundaries"
...
{
    passage: "A system of equations is given: 2x - y = 5 and x + 3y = 4.",
    question: "A system of equations is given: 2x - y = 5 and x + 3y = 4. What is the value of y?",
    answers: [
        { text: "A) 3", correct: false },
        { text: "B) 1", correct: false },
        { text: "C) 3/7", correct: true },
        { text: "D) 4/7", correct: false },
    ],
    type: "math",
    difficulty: "medium",
    category: "algebra"
...
{
    passage: "",
    question: "The function f(x) = 2x² - 3x + 5. What is the value of f(4)?",
    answers: [
...
},
{
    ...
    answers: [
        ...
        { text: "B) 9 hours", correct: false },
        { text: "C) 11 hours", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) 5/12", correct: false },
        { text: "B) 13/5", correct: false },
        { text: "C) 5/13", correct: false },
        { text: "D) 12/5", correct: true },
    ],
    type: "math",
    difficulty: "medium",
    category: "advanced-math"
...
// Advanced Math HARD
{
    ...
    answers: [
        ...
        { text: "C) 2.75 hours", correct: true },
        { text: "D) 2.8 hours", correct: false },
    ],
    difficulty: "hard",
    category: "advanced-math"
},
{
    ...
    answers: [
        { text: "A) $19,275", correct: false },
        { text: "B) $18,520", correct: true },
...
},
{
    ...
    answers: [
        ...
        { text: "B) 5/18", correct: false },
        { text: "C) 1/2", correct: false },
        { text: "D) 2/9", correct: true },
    ],
    type: "math",
    difficulty: "medium",
    category: "problem-solving"
...
},
{
    ...
    answers: [
        { text: "A) 1422", correct: false },
        { text: "B) 1346", correct: true },
        { text: "C) 1342", correct: false },
...
},
{
    ...
    answers: [
        { text: "A) 49", correct: false },
        { text: "B) 21.98", correct: false },
        { text: "C) 43.96", correct: true },
...
// Geometry and Trigonometry MEDIUM
{
    ...
    answers: [
        { text: "A) 94.2", correct: false },
        { text: "B) 282.6", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) 5/13", correct: false },
        { text: "B) 13/12", correct: false },
        { text: "C) 12/13", correct: true },
...
},
{
    ...
    answers: [
        { text: "A) 37.68", correct: false },
        { text: "B) 6.28", correct: false },
        { text: "C) 12.56", correct: false },
        { text: "D) 18.84", correct: true },
    ],
    type: "math",
    difficulty: "medium",
    category: "geometry"
...
// Geometry and Trigonometry HARD
{
    ...
    answers: [
        { text: "A) 75.36", correct: false },
        { text: "B) 50.24", correct: true },
...
},
{
    ...
    answers: [
        ...
        { text: "B) 5√2", correct: false },
        { text: "C) 10√6 / (√2 + √3)", correct: true },
