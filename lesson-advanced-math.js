...
let currentLesson = 1; // Moved to the top
...
// Define quiz arrays for all lessons
const nonlinearQuestions = [
    ...
    },
    {
        ...
        explanation: "x³ = 1, so x = 1 (real root).",
        difficulty: "easy",
        category: "advanced-math"
    },
    {
        question: "Find the vertical asymptote of y = 2/(x - 3)",
        answers: [
            { text: "A) x = 3", correct: true },
            { text: "B) x = -3", correct: false },
        ...
        explanation: "Set denominator to zero: x - 3 = 0, x = 3.",
        difficulty: "medium",
        category: "advanced-math"
    },
    {
        question: "Solve: 4^x = 16",
        answers: [
            { text: "A) x = 2", correct: true },
            { text: "B) x = 4", correct: false },
            { text: "C) x = 1", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "A) x ≤ -5 or x ≥ 5", correct: true },
            { text: "B) -5 < x < 5", correct: false },
            { text: "C) x = ±5", correct: false },
            { text: "D) All real numbers", correct: false }
        ],
        explanation: "x² ≥ 25, x ≤ -5 or x ≥ 5.",
        difficulty: "medium",
        category: "advanced-math"
    },
    {
        ...
        answers: [
            { text: "A) x = 10 or x = -2", correct: true },
            { text: "B) x = 6 or x = -6", correct: false },
            { text: "C) x = 4 or x = -4", correct: false },
            { text: "D) x = 2", correct: false }
        ],
        explanation: "x - 4 = 6 or x - 4 = -6, x = 10 or x = -2.",
        difficulty: "medium",
        category: "advanced-math"
    }
];
