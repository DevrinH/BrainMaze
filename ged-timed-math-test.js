document.addEventListener("DOMContentLoaded", () => {
    ...
    function showFinalScore() {
        ...
        // Store Math score for profile display
        localStorage.setItem("mathScore", scaledScore);

        // Do not write to gedScoreHistory to avoid affecting the chart
        console.log(`Math score ${scaledScore} saved to mathScore for ${new Date().toLocaleDateString("en-CA")}`);
    ...
    function showIntroMessage() {
        resetState();
        passageElement.innerHTML = "";
        questionElement.innerHTML = "This is a timed GED Mathematical Reasoning Test. Duration: 115 minutes with approximately 46 questions.";
        questionElement.classList.add("centered-score");
