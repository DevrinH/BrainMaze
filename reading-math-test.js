...
let refreshIntervalId; // Declare refreshIntervalId globally
...
function startReadingQuiz() {
    ...
    refreshIntervalId = setInterval(updateReadingCountdown, 1000);
...
function startMathQuiz() {
    ...
    let time = startingMinutes * 60;
    refreshIntervalId = setInterval(updateMathCountdown, 1000);
