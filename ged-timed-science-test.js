document.addEventListener("DOMContentLoaded", () => {
    ...
    function showFinalScore() {
        ...
        // Store Science score for profile display
        localStorage.setItem("scienceScore", scaledScore);

        // Do not write to gedScoreHistory to avoid affecting the chart
        console.log(`Science score ${scaledScore} saved to scienceScore for ${new Date().toLocaleDateString("en-CA")}`);
    ...
    function showIntroMessage() {
        resetState();
        passageElement.innerHTML = "";
        questionElement.innerHTML = "This is a timed GED Science Test. Duration: 90 minutes with approximately 34 questions.";
        questionElement.classList.add("centered-score");
